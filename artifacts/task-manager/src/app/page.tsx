...
import { KanbanSquare, FileCheck2, Clock, CheckCircle2, Circle, ArrowRight, AlertTriangle } from "lucide-react";
      ...
      <div className="flex-1 px-8 py-6 space-y-8">
        ...
        {overdue.length > 0 && (
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-4 flex items-center gap-3">
            ...
            <Link href="/todo" className="ml-auto text-xs font-semibold text-red-600 hover:underline whitespace-nowrap">
              Xem ngay →
            </Link>
          </div>
        )}
            ...
            {upcoming.length === 0 ? (
              ...
              <div className="space-y-3">
                {upcoming.map((task) => {
                  ...
                  return (
                    <Link href="/todo" key={task.id} className="flex items-start justify-between p-3 rounded-xl hover:bg-muted/50 transition-colors cursor-pointer group">
